      ...
      <section className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 rounded-[2rem] border border-white/10 bg-white/[0.04] p-5">
          ...
          <div className="mt-5 rounded-3xl border border-emerald-300/20 bg-emerald-400/10 p-5">
            <p className="font-black text-emerald-200">AI Result</p>
            <p className="mt-2 text-sm leading-6 text-slate-200">
              No restricted items selected. Ticket can be generated and sent to the driver phone.
            </p>
          </div>

          <Link href="/install-skips-demo/skip-ticket" className="mt-5 inline-flex rounded-2xl bg-emerald-400 px-5 py-4 text-sm font-black text-black hover:bg-emerald-300">
