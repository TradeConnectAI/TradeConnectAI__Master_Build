    ...
    <main className="min-h-screen install-skip-bg text-white">
      ...
      <section className="mx-auto max-w-[1400px] px-4 py-8 sm:px-6 lg:px-8">
        <div className="rounded-[2rem] border border-white/10 bg-white/[0.075] p-6">
          <p className="text-sm font-black uppercase tracking-[0.28em] text-yellow-300">Admin</p>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          {[
            ...
            <div key={title} className="rounded-[2rem] border border-white/10 bg-white/[0.07] p-5">
        ...
        <Link href="/install-skips-demo/operations" className="mt-6 inline-flex rounded-2xl bg-yellow-300 px-5 py-4 text-sm font-black text-black">
          Open Operations
        </Link>
      </section>
    </main>
