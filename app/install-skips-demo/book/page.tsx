    ...
    <main className="min-h-screen install-skip-bg text-white">
      ...
      <section className="mx-auto max-w-[1400px] px-4 py-8 sm:px-6 lg:px-8">
        <div className="rounded-[2rem] border border-white/10 bg-white/[0.075] p-6">
          <p className="text-sm font-black uppercase tracking-[0.28em] text-yellow-300">Customer Booking</p>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          {services.map((service) => (
            <label key={service} className="flex items-center gap-3 rounded-3xl border border-white/10 bg-white/[0.07] p-4 text-sm font-bold">
        ...
        <section className="mt-6 rounded-[2rem] border border-white/10 bg-white/[0.07] p-5">
          ...
          <div className="mt-5 rounded-3xl border border-yellow-300/25 bg-yellow-300/10 p-5">
            <p className="font-black text-yellow-200">AI Check Result</p>
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <Link href="/install-skips-demo/customer-ticket" className="rounded-2xl bg-yellow-300 px-5 py-4 text-sm font-black text-black hover:bg-white">
