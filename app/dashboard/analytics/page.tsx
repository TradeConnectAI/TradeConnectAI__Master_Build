    ...
    return (
        <DashboardShell>
            <PageContainer>
                ...
                <div className="mt-8 grid gap-6 md:grid-cols-1 md:grid-cols-2 xl:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div className="mt-8 grid gap-6 xl:grid-cols-1 md:grid-cols-2">
