  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      text:
        "Thanks for calling Install Skips beta. I can help capture a skip hire, grab hire, waste removal, or aggregates enquiry. Tell me what you need help with today.",
      at: nowTime(),
    },
  ]);
